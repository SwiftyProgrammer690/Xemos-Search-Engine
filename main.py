...
def main():
  ...
  if question == "code":
    ...
    print('A boy is a young male human. The term is usually used for a child or an adolescent. When a male human reaches adulthood, he is described as a man.')
    exit = input('Do you have anymore questions?\n')
    if exit == "Yes":
      main()
    else:
    ...
    print('Sorry we dont have info on that right now but play this game while you wait oh and report your search in Report Problems/questions.txt')
    sjfd = input('Enter your search problem and well let our developers know and well fix this problem oh and the game will be after you enter your problem')
    file = open('Report Problems/questions.txt', 'a')
    file.write(sjfd,'\n')
    file.close()
    time.sleep(5)
